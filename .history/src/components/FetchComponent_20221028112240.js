...
function FetchComponent() {
  ...
  const apiget = () => {
    ...
    .then((json) => {
      ...
      for (var i = 0; i < n; i++) {
        let m = json.prizes[i].laureats.length;
        for (var k = 0; k < json.prizes[i].laureats.length; k++) {
          const dat = createData(
            json.prizes[i].laureats[k].id,
            json.prizes[i].laureats[k].firstname
              ? json.prizes[i].laureats[k].firstname
              : "",
            json.prizes[i].laureats[k].surname
              ? json.prizes[i].laureats[k].surname
              : "",
            json.prizes[i].year,
